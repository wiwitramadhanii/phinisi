            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Form Add Pax Category</h3>
                    </div>
                    <form action="{{ route('paxCategories.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
