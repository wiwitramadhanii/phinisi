...
<div class="billing_area">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="billing-form">
                    ...
                    <form action="{{ route('bookings.store') }}" method="POST">
                        ...
                        <input type="hidden" name="time" value="{{ $package->time }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="num_pax" id="pax" class="form-control" min="{{ $minPax }}" max="{{ $maxPax }}" required>
                        </div>
            ...
            <div class="col-md-6">
                <div class="package-details">
                    ...
                    <p><strong>Pax Category:</strong> <span id="selected_pax_category">{{ $paxCategory->pax_range }} pax (Rp {{ number_format($paxCategory->price_per_pax, 0, ',', '.') }}/pax)</span></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        document.getElementById('pax').addEventListener('input', function () {
            ...
            document.getElementById('display_total_price').textContent = `Rp ${new Intl.NumberFormat('id-ID').format(totalPrice)}`;
